...
public class DatePickerControl : MonoBehaviour {
    ...
    static DatePickerControl instance;
    Action<string> callback;



    public static void OpenPicker(Action<string> back)
    {
        if (instance == null)
            instance = GameObject.FindObjectOfType<Canvas>().transform.Find("DatePicker").GetComponent< DatePickerControl>();

        instance.gameObject.SetActive(true);
      instance.callback = back;    
    }


    public void Callback()
    {
        callback(dateText.text);
